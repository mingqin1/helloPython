...
class Vector2d:
    #  __slots__ class attribute can save a lot of memory, by letting the interpreter store the instance attributes
    #  in a tuple instead of a dict.
    __slots__ = ('__x', '__y')
    typecode = 'd'
...
print('v1._Vector2d__y: ', v1._Vector2d__y)
